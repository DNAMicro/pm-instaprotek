...
**Customer ask:** Liquipel Powertek 20K PD Power Bank is not in the app for Lifetime Replacement Warranty registration.
**Flags:** none
**References used:** canned_responses.md #1 (device make/model & product-list confusion)
**Notes for Sarah:** Product-list confusion.

<!-- ===== READY-TO-PASTE REPLY ===== -->
**From:** support@instaprotek.com  (send from the support mailbox in Outlook)
**To:** simonc520@gmail.com
**Subject:** Re: Your InstaProtek support request
