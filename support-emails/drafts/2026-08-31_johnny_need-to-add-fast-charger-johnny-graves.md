...
**Customer ask:** Asks to have his fast charger added to the list for the lifetime warranty.
**Flags:** none
**References used:** canned_responses.md #1 (device make/model & product-list confusion)
**Notes for Sarah:** Canned #1 match.

<!-- ===== READY-TO-PASTE REPLY ===== -->
**From:** support@instaprotek.com  (send from the support mailbox in Outlook)
**To:** johnnygraves32@gmail.com
**Subject:** Re: Need to add fast charger
