...
**Customer ask:** Entered the cable at the make/model step and cannot locate the product.
...
**Notes for Sarah:** Textbook #1 - she is entering the cable where the phone belongs.

<!-- ===== READY-TO-PASTE REPLY ===== -->
**From:** support@instaprotek.com  (in-thread draft in the support mailbox)
**To:** lgoodhealthcare@gmail.com
**Subject:** Re: 
