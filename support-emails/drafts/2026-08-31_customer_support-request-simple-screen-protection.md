...
**Customer ask:** Trying to register a Simple screen protection product and cannot find it.
**Flags:** none
**References used:** canned_responses.md #1 (device make/model & product-list confusion)
**Notes for Sarah:** Canned #1 match. No name given, so the greeting stays neutral.
