...
PDF="/home/farsheed/pm-instaprotek/tmp/run-2026-09-16/evidence/settings/test.pdf"
...
def main(key):
    ...
    with sync_playwright() as p:
        ...
        pg.goto(BASE+route, wait_until="domcontentloaded", timeout=40000); slib.wait_grid(pg, filt)
        if key=="plan":
