...
PDF="/home/farsheed/pm-instaprotek/tmp/run-2026-09-16/evidence/terms_test.pdf"
R={}
...
with sync_playwright() as p:
    ...
    if False:  # DISABLED 2026-09-16: grid search does not filter; this opened a real production record
